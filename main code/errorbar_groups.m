...
%
% 'subPlotSpec': A 3-element vector that specifies the subplot. First
% element indicates total number of rows, second element indicates total
% number of columns and third number indicates subplot ID (see subplot)
%
...
% Modified by Sebastian Musslick: 11.01.2017. Added subplot functionality
...
if ~isempty(subPlotSpec)
    subplot(subPlotSpec(1), subPlotSpec(2), subPlotSpec(3));
end
hold on;
