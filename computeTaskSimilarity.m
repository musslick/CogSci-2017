...
function [hiddenSimilarity, outputSimilarity] = CorrTaskAvg(taskNet, inputPatterns, taskPatterns, relevantTasks, avgType, corrType)
           ...
           switch avgType
               ...
               case 'Median'
                   hiddenTaskAvg = hiddenTaskAvg - repmat(median(hiddenTaskAvg,1) ,size(hiddenTaskAvg,2), 1);
                    outputTaskAvg = outputTaskAvg - repmat(median(outputTaskAvg,1) ,size(outputTaskAvg,2), 1);
           end
